...
def GetTwoFourHour():
	global WeatherList
	try:
		url = requests.get('https://api.openweathermap.org/data/3.0/onecall?lat='+account.latitude+'&lon='+account.longitude+'&exclude=minutely,daily&units=imperial&lang=en&appid='+account.account, timeout=2)
